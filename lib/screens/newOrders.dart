...
class newOrders extends StatelessWidget {
  ...
  Widget _listViewBuilder(model) {
    if (model.getNewServiceRequestsList.length > 0 ||
        model.getNewServiceRequestsList.length == null) {
      return ListView.builder(
        itemCount: model.getNewServiceRequestsList.length,
                        ...
                        title: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                    model.getNewServiceRequestsList[index]
                                        .transDesc,
                                    style: TextStyle(
                                        fontFamily: 'arabic',
                              ...
                              Container(
                                child: Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.bold,
                                        color: model
                                            .getNewServiceRequestsList[index]
                                            .color)),
                              ),
                            ]),
                        subtitle: Text(
                            model.getNewServiceRequestsList[index].transdate
                                    .toString()
                                    .substring(0, 10) +
                                '  - ' +
                                model.getNewServiceRequestsList[index].transdate
